...
VULN_DISPLAY_NAMES: dict[str, str] = {
    ...
    "open_redirect": "开放重定向",
    "crypto_weakness": "弱加密",
    "weak_crypto": "弱加密（硬编码 DES/RC 等弱算法）",
    "insecure_hash": "弱哈希（MD5/SHA-1 等不安全摘要算法）",
    "weak_randomness": "弱随机数（java.util.Random/Math.random）",
    "secure_cookie": "Cookie 未启用 Secure 属性",
    "trust_boundary": "信任边界违反（未校验数据入会话）",
    "log_injection": "日志注入",
